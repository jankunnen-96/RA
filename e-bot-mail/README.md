...
| `PERSONAL_NOTIFY_EMAIL` | No | `jan.kunnen@hotmail.com` | Also receives success notifications, and is the sole recipient of "missed" notifications when an accepteren attempt fails |
